...
Where *n*<sub>*m**k*</sub> is the number of observations in the *m*<sup>*t**h*</sup> terminal node belonging to the *k*<sup>*t**h*</sup> class. A small deviance indicates a tree that provides a good fit to the (training) data. The residual mean deviance reported is simply the deviance divided by *n* − |*T*<sub>0</sub>|, which in this case is 400 − 27 = 373.
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-10-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-11-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-13-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-15-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-16-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-17-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-18-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-20-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-24-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-26-1.png)
...
![](lab_8_files/figure-markdown_github/unnamed-chunk-27-1.png)

``` r
plot(boost_boston, i="lstat", main = "Partial Dependence of Median Value on `lstat`") 
```

![](lab_8_files/figure-markdown_github/unnamed-chunk-27-2.png)
...
The test MSE obtained is 10.8; similar to the test MSE for random forests and superior to that for bagging. If we want to, we can perform boosting with a different value of the shrinkage parameter *λ* in (8.10). The default value is 0.1, but this is easily modified. Here we take *λ* = 0.001.
...
In this case, using learning rate *λ* = 0.001 leads to a slightly greater test MSE than *λ* = 0.001. From the documentation:
